...
WebUI.verifyElementClickable(findTestObject('Login/button_MasukorDaftar'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Login/textbox_Username'), 'v.edy.rachyanto@adira.co.id')

WebUI.takeScreenshot()

WebUI.verifyElementVisible(findTestObject('Login/textbox_Password'))

WebUI.setText(findTestObject('Login/textbox_Password'), 'RaGib@0826')
